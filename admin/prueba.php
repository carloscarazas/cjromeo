...
$alumnos="SELECT * FROM tp_licencia_conductor";
	...
	<body>
		...
		<section>
				...
				<table class="table">
				  ...
				  echo '<tr>
				    	<td>'.$registroAlumno['nro_licencia'].'</td>
				    	<td>'.$registroAlumno['dni_lic'].'</td>
				    	<td>'.$registroAlumno['fecha_revalidacion_lic'].'</td>
				    	<td>'.$registroAlumno['clase_lic'].'</td>
				    </tr>';
				   }
			...
			<form method="post">
				...
				<table class="table bg-info"  id="tabla">
					<tr class="fila-fija">
						<td><input name="idalumno" placeholder="ID Alumno"/></td>
