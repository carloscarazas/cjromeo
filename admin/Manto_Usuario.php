...
<!--                    control de caja no va-->
                       
<!--    
                        <li class="treeview" id="liCajas">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">                
                            	<li id="liCaj"><a href="#" ><i class="fa fa-circle-o"></i> Control de Caja</a></li>                
                            </ul>
                        </li>

                        <li class="treeview" id="liCompras">
                            <a href="#">
                                <i class="fa fa-th"></i>
                                <span>Compras</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <li id="liIng"><a href="Compras_Ingresos.php" ><i class="fa fa-circle-o"></i> Ingresos</a></li>
                            <li id="liProveedores"><a href="Compras_Proveedor.php"><i class="fa fa-circle-o"></i> Proveedores</a></li>
                             </ul>
                        </li>
                        <li class="treeview" id="liVentas">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li id="liPedidos"><a href="Ventas_Ventas.php"><i class="fa fa-circle-o"></i> Ventas</a></li>
                                <li id="liVenta"><a href="Ventas_Pedidos.php"><i class="fa fa-circle-o"></i> Pedidos</a></li>                
                                <li id="liClientes"><a href="Ventas_Clientes.php"><i class="fa fa-circle-o"></i> Clientes</a></li>                                   
                            </ul>
                        </li>-->
                ...
                <div class="panel-heading">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a href="Manto_Usuario.php" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></a>
                        </div>
                    </div>
                </div>    
                <!-- /.box-header -->
                            ...
                            <div class="col-sm-14"  id="VerForm">
                                <form role="form" name="frmArticulos" id="frmArticulos" enctype="multipart/form-data">                    	
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <?php include "recursos/UsuarioFormularioManto.html"; ?>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 left">
                                            <h5></h5>
                                            <button class="btn btn-success" type="submit"><i class="fa fa-floppy-o"></i> Registrar</button>
                                            <a href="Manto_Usuario.php" class="btn btn-primary" ><i class="fa fa-remove"></i> Cancelar</a>
                                            <hr>
